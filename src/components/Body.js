export default function Body({file, handleFileInputChange, handleUploadClick, prediction}) {
    ...
    <>
        ...
        <div class="image-preview shadow-xl" id="imagePreview">
        ...
        <div id="button-and-input-container">
            ...
            <button type="submit" class="image-upload-button bg-white hover:bg-gray-200 mt-2" id="imageUploadButton" onClick={() => handleUploadClick(file)}>Get Prediction</button>
        </div>
    </>
    );
}